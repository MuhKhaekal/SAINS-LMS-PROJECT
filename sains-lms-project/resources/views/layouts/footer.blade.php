<div class="w-full bg-primary flex px-24 text-secondary pt-8 space-x-8">
    <section class="w-1/3">
        <h1 class="font-bold">[ SAINS UNHAS ]</h1>
        <p>Bangun dan wujudkan cita bersama SAINS</p>
        <div class="relative bg-secondary mt-10 p-4 rounded-t-md">
            <div class="text-primary flex ms-5">
                <div class="text-xs flex-1 text-center">                    
                    <p>Email</p>
                    <p>sainsunhas@gmail.ac.id</p>
                </div>
                <div class="text-xs flex-1 text-center">                    
                    <p>Ikhwan:</p>
                    <p>082345643122</p>
