            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-gray-100 text-primary border-b">
                        <td class="px-6 py-4">
                            <input type="checkbox" name="ids[]" value="{{ $prodi->id }}" class="checkItem" data-id="{{ $prodi->id }}">
                        </td>
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <div class="p-4 md:p-5 space-y-4 mb-4">
                <div class="">
                    ...
                    <x-text-input-secondary id="prodi_code" class="block w-full mt-1" type="text" name="prodi_code" :value="old('prodi_code')" required autofocus autocomplete="username" placeholder="Kode Prodi" />
                    <x-input-error :messages="$errors->get('prodi_code')" />
                </div>
                <div class="">
                    <p class="text-secondary">Nama Program Studi</p>
                    <x-text-input-secondary id="prodi_name" class="block w-full mt-1" type="text" name="prodi_name" :value="old('prodi_name')" required autofocus autocomplete="username" placeholder="Program Studi" />
                    <x-input-error :messages="$errors->get('prodi_name')" />
                </div>
                <div class="">  
                    <p class="text-secondary">Fakultas</p>
                    <select id="faculty_id" name="faculty_id" class="bg-secondary border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"> 
              ...
              <div class="p-4 md:p-5 space-y-4">
                <div class="flex flex-col items-center justify-center w-full">
                    <label for="file-upload" 
                      ...
                      <svg class="w-12 h-12 mb-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
