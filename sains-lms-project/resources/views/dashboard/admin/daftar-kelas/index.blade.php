...
@section('content')
<h1 class="text-primary font-extrabold text-2xl mt-20 md:mt-6 md:mx-12">Daftar Kelas</h1>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-gray-100 text-primary border-b">
                        <td class="px-6 py-4">
                            <input type="checkbox" name="ids[]" value="{{ $classPai->id }}" class="checkItem" data-id="{{ $classPai->id }}">
                        </td>
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <div class="p-4 md:p-5 space-y-4 mb-4">
                <div class="">
                    ...
                    <x-text-input-secondary id="class_name" class="block w-full mt-1" type="text" name="class_name" :value="old('class_name')" required autofocus autocomplete="class_name" placeholder="Nama Kelas" />
                    <x-input-error :messages="$errors->get('class_name')" />
                </div>
                <div class="">
                    <p class="text-secondary">Nama Dosen</p>
                    <x-text-input-secondary id="lecturer" class="block w-full mt-1" type="text" name="lecturer" :value="old('lecturer')" required autofocus autocomplete="lecturer" placeholder="Nama Dosen" />
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <form action="" method="POST" id="formUpdate">
                ...
                <div class="p-4 md:p-5 space-y-4 mb-4">
                    ...
                    <div class="">
                        <p class="text-secondary">Nama Dosen</p>
                        <x-text-input-secondary id="lecturer" class="block w-full mt-1" type="text" name="lecturer" :value="old('lecturer')" required autofocus autocomplete="Nama Dosen" placeholder="Nama Dosen" />
                        <x-input-error :messages="$errors->get('lecturer')" />
                    </div>
                  </div>
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <div class="p-4 md:p-5 space-y-4">
                <div class="flex flex-col items-center justify-center w-full">
                    ...
                    <p class="text-secondary text-center mt-5">Apakah anda yakin untuk menghapus data "<span id="class_name"></span>"?</p>
                </div>
              </div>
