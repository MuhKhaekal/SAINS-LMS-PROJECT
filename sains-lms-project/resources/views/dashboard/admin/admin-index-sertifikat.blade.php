...
@section('content')
    ...
    <section class="bg-white shadow-md mt-5 md:mx-12 p-6">
        <div class="">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum cupiditate ipsa, quaerat atque harum et id in,
            quam accusamus debitis ullam assumenda iusto consectetur repudiandae, illo commodi perspiciatis recusandae
            excepturi.
        </div>
        <div class="mt-5">
            <x-primary-button>
