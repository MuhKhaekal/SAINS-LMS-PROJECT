            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-gray-100 text-primary border-b">
                        <td class="px-6 py-4">
                            <input type="checkbox" name="ids[]" value="{{ $faculty->id }}" class="checkItem" data-id="{{ $faculty->id }}">
                        </td>
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <div class="p-4 md:p-5 space-y-4 mb-4">
                <div class="">
                    ...
                    <x-text-input-secondary id="faculty_code" class="block w-full mt-1" type="text" name="faculty_code" :value="old('faculty_code')" required autofocus autocomplete="faculty_code" placeholder="Kode Fakultas" />
                    <x-input-error :messages="$errors->get('faculty_code')" />
                </div>
                <div class="">
                    <p class="text-secondary">Nama Fakultas</p>
                    <x-text-input-secondary id="faculty_name" class="block w-full mt-1" type="text" name="faculty_name" :value="old('faculty_name')" required autofocus autocomplete="faculty_name" placeholder="Nama Fakultas" />
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <form action="" method="POST" id="formUpdate">
                ...
                <div class="p-4 md:p-5 space-y-4 mb-4">
                    ...
                    <div class="">
                        <p class="text-secondary">Nama Fakultas</p>
                        <x-text-input-secondary id="faculty_name" class="block w-full mt-1" type="text" name="faculty_name" :value="old('faculty_name')" required autofocus autocomplete="Nama Fakultas" placeholder="faculty_name" />
                        <x-input-error :messages="$errors->get('faculty_name')" />
                    </div>
                  </div>
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <div class="p-4 md:p-5 space-y-4">
                <div class="flex flex-col items-center justify-center w-full">
                    ...
                    <p class="text-secondary text-center mt-5">Apakah anda yakin untuk menghapus data "<span id="faculty_name"></span>"?</p>
                </div>
              </div>
