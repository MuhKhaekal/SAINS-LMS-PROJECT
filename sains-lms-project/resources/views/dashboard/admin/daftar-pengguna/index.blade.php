            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-gray-100 text-primary border-b">
                        <td class="px-6 py-4">
                            @if ($user->role !== 'admin')
                                <input type="checkbox" name="ids[]" value="{{ $user->id }}" class="checkItem" data-id="{{ $user->id }}">
                            @endif
                        </td>
...
<section class="md:mx-12 mt-10 flex justify-center md:justify-start md:mt-5 gap-4">
    ...
    <x-primary-button class="text-center" data-modal-target="default-modal-excel" data-modal-toggle="default-modal-excel">
        {{ __('+ Impor Excel') }}
    </x-primary-button> 
</section>
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <div class="p-4 md:p-5 space-y-4 mb-4">
                <div class="">
                    ...
                    <x-text-input-secondary id="nama" class="block w-full mt-1" type="text" name="nama" :value="old('nama')" required autofocus autocomplete="username" placeholder="Nama" />
                    <x-input-error :messages="$errors->get('nama')" />
                </div>
                <div class="">
                    <p class="text-secondary">NIM</p>
                    <x-text-input-secondary id="nim" class="block w-full mt-1" type="text" name="nim" :value="old('nim')" required autofocus autocomplete="username" placeholder="NIM" />
                    <x-input-error :messages="$errors->get('nim')" />
                </div>
                <div class="">
                    <p class="text-secondary">Password</p>
                    <x-text-input-secondary id="password" class="block w-full mt-1" type="password" name="password" :value="old('password')" required autofocus autocomplete="username" placeholder="Password" />
                    <x-input-error :messages="$errors->get('password')" />
                </div>
                <div class="">
                    <p class="text-secondary">Konfimasi Password</p>
                    <x-text-input-secondary id="password_confirmation" class="block w-full mt-1" type="password" name="password_confirmation" :value="old('password_confirmation')" required autofocus autocomplete="username" placeholder="Konfirmasi Password" />
                    <x-input-error :messages="$errors->get('password')" />
                </div>
                <div class="">  
                    <p class="text-secondary">Jenis Kelamin</p>
                    <select id="gender" name="gender" class="bg-secondary border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">                    
                ...
                <div class="">  
                    ...
                    <select id="halaqah_id" name="halaqah_id" class="bg-secondary border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"> 
                ...
                <div class="">  
                    ...
                    <select id="role" name="role" class="bg-secondary border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">                    
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <form action="" method="POST" id="formUpdate">
                ...
                <div class="p-4 md:p-5 space-y-4 mb-4">
                    ...
                    <div class="">
                        <p class="text-secondary">Password</p>
                        <x-text-input-secondary id="password" class="block w-full mt-1" type="password" name="password" :value="old('password')" autofocus autocomplete="username" placeholder="Password" />
                        <x-input-error :messages="$errors->get('password')" />
                    </div>
                    <div class="">
                        <p class="text-secondary">Konfimasi Password</p>
                        <x-text-input-secondary id="password_confirmation" class="block w-full mt-1" type="password" name="password_confirmation" :value="old('password_confirmation')" autofocus autocomplete="username" placeholder="Konfirmasi Password" />
                        <x-input-error :messages="$errors->get('password')" />
                    </div>
                    <div class="">  
                        <p class="text-secondary">Jenis Kelamin</p>
...
<section>
    ...
    <div id="default-modal-excel" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative p-4 w-full max-w-2xl max-h-full mt-36 md:mt-0">
        <div class="relative bg-primary rounded-lg shadow-sm px-4">
          <form id="excel-upload-form" action="{{ route('daftar-pengguna.importExcel') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
            ...
            <div class="p-4 md:p-5 space-y-4">
              <div class="flex flex-col items-center justify-center w-full">
                <label for="file-upload"
                  ...
                  <svg class="w-12 h-12 mb-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex justify-center gap-5 p-4 md:p-5 border-t border-gray-200 rounded-b">
              ...
              <x-secondary-button id="submit-btn" class="text-center opacity-50 cursor-not-allowed" disabled>
                {{ __('Simpan') }}
              </x-secondary-button>
            </div>
          </form>
          ...
          form.addEventListener('submit', function (e) {
            ...
            xhr.addEventListener('load', () => {
              ...
              if (xhr.status >= 200 && xhr.status < 300 && response.success) {
                ...
                progressText.textContent = response.message || 'Upload dan import berhasil! Memuat ulang...';
          ...
          <div class="relative bg-primary rounded-lg shadow-sm px-4">
              ...
              <div class="p-4 md:p-5 space-y-4">
                <div class="flex flex-col items-center justify-center w-full">
                    ...
                    <p class="text-secondary text-center mt-5">Apakah anda yakin untuk menghapus akun "<span id="nama"></span>"?</p>
                </div>
              </div>
