...
<section class="mx-4 md:mx-12 md:flex md:mt-5 md:gap-24">
    <section class="md:flex-1">
        <form action="{{ route('pengumuman.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <textarea name="content" id="message" rows="4" class="shadow-md block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-gray-500 focus:border-gray-500 " placeholder="Isi pengumuman disini ... "></textarea>
            <x-input-error :messages="$errors->get('content')" />

            <label class="block mb-2 text-sm mt-4 text-gray-900 md:text-xl" for="file_input">Lampiran</label>
            <input class="p-2 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" 
            id="file_input" 
            type="file"
            name="file_location" 
              ...
              <form action="" method="POST" id="formUpdate" enctype="multipart/form-data">
                ...
                <div class="p-4 md:p-5 space-y-4 mb-4">
                    <div class="">
                        ...
                        <textarea name="content" id="content" rows="4" class="shadow-md block p-2.5 w-full text-sm text-primary bg-secondary rounded-lg border border-gray-300 focus:ring-gray-500 focus:border-gray-500 " placeholder="Isi pengumuman disini ... "></textarea>
                        <x-input-error :messages="$errors->get('content')" />
                    </div>
                    <div class="">
