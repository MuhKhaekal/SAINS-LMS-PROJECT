...
<body class="font-poppins">
    <div class="flex">
        ...
        <div id="mobileSidebar"
            ...
            <!-- Menu -->
            <div class="h-full overflow-y-auto flex flex-col flex-1 mt-0 no-scrollbar">
                <ul class="space-y-4">
                    <li class="text-lg font-semibold rounded-lg mx-2 px-5 py-3 flex justify-items-center hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('dashboard') ? 'text-secondary bg-gray-600 ' : ' text-gray-500 hover:bg-gray-700 group' }}">
                    ...
                    <li class="text-lg font-semibold rounded-lg mx-2 px-5 py-3 flex justify-items-center hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('daftar-pengguna.*') ? 'text-secondary bg-gray-600' : ' text-gray-500  hover:bg-gray-700 group' }}">
                        <svg class="w-6 h-6 me-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="text-lg font-semibold rounded-lg mx-2 px-5 py-3 flex justify-items-center hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('daftar-fakultas.*') ? 'text-secondary bg-gray-600' : ' text-gray-500  hover:bg-gray-700 group' }}">
                        <svg class="w-6 h-6 me-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="text-lg font-semibold rounded-lg mx-2 px-5 py-3 flex justify-items-center hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('faq.*') ? 'text-secondary bg-gray-600' : ' text-gray-500  hover:bg-gray-700 group' }}">
                        <svg class="w-6 h-6 me-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="text-lg font-semibold rounded-lg mx-2 px-5 py-3 flex justify-items-center hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('pengumuman.*') ? 'text-secondary bg-gray-600' : ' text-gray-500  hover:bg-gray-700 group' }}">
                        <svg class="w-6 h-6 me-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M17 6h-2V5h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2h-.541A5.965 5.965 0 0 1 14 10v4a1 1 0 1 1-2 0v-4c0-2.206-1.794-4-4-4-.075 0-.148.012-.22.028C7.686 6.022 7.596 6 7.5 6A4.505 4.505 0 0 0 3 10.5V16a1 1 0 0 0 1 1h7v3a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-3h5a1 1 0 0 0 1-1v-6c0-2.206-1.794-4-4-4Zm-9 8.5H7a1 1 0 1 1 0-2h1a1 1 0 1 1 0 2Z"/>
                        </svg>  
                        <a href="{{ route('pengumuman.index') }}">Pengumuman</a>
                    </li>
                    <li class="text-lg font-semibold rounded-lg mx-2 px-5 py-3 flex justify-items-center hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('sertifikat.*') ? 'text-secondary bg-gray-600' : ' text-gray-500  hover:bg-gray-700 group' }}">
                        <svg class="w-6 h-6 me-5 aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="text-lg font-semibold rounded-lg mx-2 px-5 py-3 flex justify-items-center hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('laporan.*') ? 'text-secondary bg-gray-600' : ' text-gray-500  hover:bg-gray-700 group' }}">
                        <svg class="w-6 h-6 me-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
