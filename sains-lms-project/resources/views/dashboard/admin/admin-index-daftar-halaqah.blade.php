...
@section('page-title', 'Daftar Halaqah')

@section('content')
<h1 class="font-extrabold text-2xl mt-20 md:mt-6 md:mx-12">Daftar Halaqah</h1>
            ...
            <tbody>
                <tr class="bg-white hover:bg-gray-100 text-primary border-b">
                    ...
                    <td class="px-6 py-4 flex gap-2 items-center">
                        ...
                        <a href="#" class="font-medium text-green-500 hover:underline">Laporan</a>
                    </td>
                </tr>
            </tbody>
        </table>
