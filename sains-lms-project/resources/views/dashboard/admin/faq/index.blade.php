...
<section class="md:flex md:flex-row-reverse md:mx-12 md:gap-5">
    ...
    <section class="overflow-y-auto h-60 md:min-h-screen border border-dashed rounded-md border-blue-200 mt-5 p-2 text-xs md:text-sm md:flex-1">
        @forelse ($faqs as $faq)
              ...
              <form action="" method="POST" id="formUpdate">
                ...
                <div class="p-4 md:p-5 space-y-4 mb-4">
                    <div class="">
                        ...
                        <x-text-input-secondary id="question" class="block w-full mt-1" type="text" name="question" :value="old('question')" required autofocus autocomplete="username" placeholder="Masukkan Pertanyaan" />
