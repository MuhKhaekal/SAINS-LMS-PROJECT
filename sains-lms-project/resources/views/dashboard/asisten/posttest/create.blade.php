...
@section('page-title', 'SAINS | Input Posttest')
...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:mt-24">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Input Nilai Post-Test</h1>
                <div class="flex items-center gap-2 mt-1 text-sm text-gray-500">
                    <span>{{ $selectedHalaqah->halaqah_name }}</span>
                    <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span class="font-medium text-gray-700">Penilaian Akhir</span>
                </div>
            </div>
            <div>
                <a href="{{ url()->previous() }}"
        ...
        <div
            ...
            <form id="nilaiForm" action="{{ route('posttest.store') }}" method="POST">
                @csrf
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach ($praktikans as $index => $praktikan)
                            @php
                                $data = $posttests[$praktikan->id] ?? null;
                            @endphp
                            ...
                            <tr class="bg-white hover:bg-gray-50 transition-colors row-user group"
                                ...
                                <td class="px-4 py-4 text-center">
                                    <input type="number" name="posttests[{{ $praktikan->id }}][kbq]"
                                ...
                                <td class="px-4 py-4 text-center">
                                    <input type="number" name="posttests[{{ $praktikan->id }}][hb]"
                                ...
                                <td class="px-4 py-4 text-center">
                                    <input type="number" name="posttests[{{ $praktikan->id }}][mh]"
