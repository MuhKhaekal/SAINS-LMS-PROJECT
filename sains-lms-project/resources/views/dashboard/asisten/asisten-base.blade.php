...
<body class="font-poppins bg-slate-100 ">
    ...
    <div class="mt-16 mb-20 md:mt-0 no-scrollbar">
        @yield('content')
    </div>
    ...
    <div class="md:hidden relative"">
        <div class="fixed bottom-0 w-full bg-primary rounded-t-xl">
            <ul class="flex justify-center">
                <li class="text-xs font-semibold rounded-lg m-2 py-3 w-1/3 hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('dashboard') ? 'text-secondary bg-gray-600 ' : ' text-gray-500 hover:bg-gray-700 group' }}">
                ...
                <li class="text-xs font-semibold rounded-lg m-2 py-3 w-1/3 hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('halaqah-asisten.*') ? 'text-secondary bg-gray-600 ' : ' text-gray-500 hover:bg-gray-700 group' }}">
                ...
                <li class="text-xs font-semibold rounded-lg m-2 py-3 w-1/3 hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('pengumuman-asisten.*') ? 'text-secondary bg-gray-600 ' : ' text-gray-500 hover:bg-gray-700 group' }}">
                ...
                <li class="text-xs font-semibold rounded-lg m-2 py-3 w-1/3 hover:bg-gray-700 hover:text-gray-300 {{ request()->routeIs('faq-asisten.*') ? 'text-secondary bg-gray-600 ' : ' text-gray-500 hover:bg-gray-700 group' }}">
