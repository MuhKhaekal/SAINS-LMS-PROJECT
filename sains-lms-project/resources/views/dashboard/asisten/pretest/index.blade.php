    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:mt-24">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            ...
            <div class="flex gap-2">
                ...
                {{-- Tombol Input Nilai (Opsional, jika ingin diarahkan ke form input) --}}
                {{-- <a href="{{ route('pretest.create', ['halaqah_name' => $selectedHalaqah->halaqah_name]) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-medium text-sm text-white shadow-sm hover:bg-indigo-700 transition">
