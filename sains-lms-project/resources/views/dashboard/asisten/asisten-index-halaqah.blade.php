...
<div class="m-2">
    <div style="background-image: url('/assets/images/background-halaqah.png');"
     class="bg-no-repeat bg-top bg-contain md:bg-cover w-full rounded-lg">
        <div class="relative text-secondary md:w-1/2 md:mx-24">
            <h1 class="font-semibold text-xl text-center py-10" data-aos="fade-right">
                Sistem Informasi 1
            </h1>
        </div>
    </div>
...
<section class="akumulasi-nilai grid grid-cols-1 gap-2 m-3">
    <div class="border shadow-md p-4 text-xs font-bold rounded-lg">
...
<section class="mx-4">  
    <div id="accordion-1" class="my-2">
      <h2>
        <button type="button" 
                class="shadow-md flex text-xs items-center justify-between w-full p-5 font-medium rtl:text-right rounded-t-xl bg-white transition-colors duration-300 focus:outline-none"
                data-target="#accordion-body-1">
                <span class="w-1/3 bg-secondary text-primary font-bold p-1 me-2 rounded-md">Pertemuan 1</span>
                <span class="font-bold flex-1">Lorem, ipsum dolor sit amet consectetur adipisicing elit</span>
      ...
      <div id="accordion-body-1" 
        ...
        <div class="p-5 border border-b-0 border-gray-200 bg-white text-xs">
            ...
            <div class="border p-3">
                <a href="" class="flex items-center">
                    ...
                    <p class="font-bold">Unggah Materi</p>
                </a>
            </div>
            <div class="border p-3">
                <a href="" class="flex items-center">
                    ...
                    <p class="font-bold">Unggah Tugas</p>
                </a>
            </div>
        </div>
      </div>
...
<section class="mx-4 mt-4 mb-48">
    <x-primary-button-full class="text-center">
        {{ __('+ Tambah Materi') }}
