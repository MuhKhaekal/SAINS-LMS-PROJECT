...
<section class="mx-4 md:mx-32">  
    <div id="accordion-1" class="my-2">
        ...
        <div class="flex items-center md:justify-start md:gap-3 w-full md:text-lg">
            <span class="md:w-52 bg-secondary text-primary font-bold p-1 me-2 rounded-md w-56">Pertemuan 1</span>
            <span class="font-bold text-left">Lorem, ipsum dolor sit amet consectetur adipisicing elit</span>
        </div>

        <svg data-accordion-icon class="w-3 h-3 shrink-0 ms-2 flex-none" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
      ...
      <div id="accordion-body-1" 
        ...
        <div class="p-5 border border-b-0 border-gray-200 bg-white text-xs md:text-lg">
...
<section class="mx-4 mt-4 mb-48 md:mx-32">
