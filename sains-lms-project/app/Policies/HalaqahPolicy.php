...
class HalaqahPolicy
{
    ...
    {
        return $user->halaqahs->contains('id', $halaqah->id);
    }
     ...
     */
    public function restore(User $user, Halaqah $halaqah): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, Halaqah $halaqah): bool
    {
        return false;
    }
}
